...
try:
    ...
    try:
        from models.backbones.cnn_encoder import CNNMultimodalTransformer
    except ImportError:
...
def main():
    parser = argparse.ArgumentParser(description='训练CNN Baseline')
