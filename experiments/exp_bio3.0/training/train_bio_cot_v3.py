...
from models.bio_cot_v3 import BioCOT_v3, sparse_loss, create_bio_cot_v3
...
def visualize_training(history: Dict, log_dir: Path, timestamp: str, best_auc: float):
    ...
    # 添加总标题
    fig.suptitle(f'Bio-COT 3.0 Training Results (Best AUC: {best_auc:.4f})', 
...
def main():
    ...
    log_print("=" * 80)
    log_print("Bio-COT 3.0: 知识笔记引导的因果最优传输架构")
    log_print("=" * 80)
