...
OUTPUT_ROOT="models/MedicalViT/_results"
...
echo "🚀 开始MedicalViT多模态训练"
echo "============================================================"
echo "模型: $VIT_MODEL (医学专用)"
echo "Epochs: $EPOCHS"
...
CUDA_VISIBLE_DEVICES=$GPU_ID nohup python models/MedicalViT/scripts/start_medical_vit_multimodal.py \
    --data_path $DATA_PATH \
    --epochs $EPOCHS \
