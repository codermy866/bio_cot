...
def prepare_data_loaders(data_path='/data2/hmy/5Center_datas/5centers_multi_leave_centers_out', batch_size=6, num_workers=4):
    """准备数据加载器"""
    print("📥 加载数据集...")
    ...
    # - train -> internal_train/train/
    # - val/test -> internal_train/val/ (内部验证集)
    try:
